...
import 'package:productivity_timer/radial/arc_progress_indicator.dart';
import 'package:productivity_timer/radial/radial_menu_button.dart';
import 'package:productivity_timer/radial/radial_menu_center_button.dart';
import 'package:productivity_timer/radial/radial_menu_item.dart';
...
class RadialMenu<T> extends StatefulWidget {
     ...
     const RadialMenu({
          ...
          this.radius = Configuration.RADIAL_MENU_RADIUS,
          this.menuAnimationDuration = const Duration(milliseconds: Configuration.RADIAL_MENU_ANIMATION_DURATION_MSEC),
          this.progressAnimationDuration = const Duration(milliseconds: Configuration.RADIAL_MENU_SELECTION_RING_DURATION_MSEC),
     })  : assert(radius != null),
